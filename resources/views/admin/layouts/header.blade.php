...
<div class="header-area mb-4 light-header">
    <div class="row align-items-center">
        <div class="mobile-logo d_none_lg">
            <a href="{{route('admin.dashboard')}}"><img style="max-width:120px; !important" src="{{asset('assets/img/logo/logo2.png')}}" alt="logo"></a>
        </div>
                ...
                <li class="user-dropdown">
                    <div class="dropdown">
                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d_none_sm">CoxwellHospital Admin <i class="feather ft-chevron-down"></i></span>
                        ...
                        <div class="dropdown-menu dropdown_user" aria-labelledby="dropdownMenuButton" >
                            <div class="dropdown-header d-flex flex-column align-items-center">
                                ...
                                <div class="user_bio text-center">
                                    <p class="name font-weight-bold mb-0">CoxwellHospital Admin</p>
