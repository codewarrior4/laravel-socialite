                ...
                <div class="card-body card_icon_right">
                    <div class="row">
                        <div class="col">
                            ...
                            <span class="font-weight-bold display-1 mb-0">{{count($blogs)}}</span>
                        </div>
                        <div class="col-auto">
                            <div class="icon_rounded mb-3 icon_primary" style="cursor: pointer" onclick="window.location.href='{{route('admin.blog.create')}}'">
                                <i class="feather ft-plus" aria-hidden="true"></i> 
